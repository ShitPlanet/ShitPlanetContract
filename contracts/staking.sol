...
contract StakingRewards is IStakingRewards {
    ...
    function stake(uint256 boxId) external updateReward(msg.sender) {
    ...
    function withdraw(uint256 boxId) public updateReward(msg.sender) {
